...
class SubscribePostTest(TestCase):
    ...
    def test_subscription_email_to(self):
        ...
        self.assertIn('Vitor Roxo', email.body)
        self.assertIn('13830124740', email.body)
        self.assertIn('vitor.icnv@gmail.com', email.body)
        self.assertIn('21-98127-5014', email.body)
